...
export default async function GuidePage() {
    ...
    const tools = [
        ...
        { id: "productDiscovery", title: t('GuidePage.tools.productDiscovery.title'), content: t('GuidePage.tools.productDiscovery.content') },
        { id: "adRadar", title: t('GuidePage.tools.adRadar.title'), content: t('GuidePage.tools.adRadar.content') },
