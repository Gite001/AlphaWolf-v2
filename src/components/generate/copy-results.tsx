...
import { Copy, CopyCheck, AlertCircle, Loader2, ImageDown, FileAudio } from 'lucide-react';
                ...
                <div className="flex w-full sm:w-auto gap-2">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button asChild variant="outline" size="icon" className="flex-1 sm:flex-none" disabled={!imageUrl || isGeneratingImage || imageError}>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                             <Button asChild variant="outline" size="icon" className="flex-1 sm:flex-none" disabled={!audioUrl || isGeneratingAudio}>
